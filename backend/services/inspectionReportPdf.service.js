...
const drawHeader = (doc, report) => {
    ...
    // OFFICE ADDRESS
    // =========================================================
    const rightStartX = MARGIN_LEFT + 405;
    const rightWidth = CONTENT_WIDTH - 420;
    ...
    doc.font("Helvetica")
        ...
        .text(
            ...
            "Lower Ground Floor, Plot C-1A, Sector 4,\n" +
            "Greater Noida West",
            rightStartX,
            MARGIN_TOP + 27,
            {
